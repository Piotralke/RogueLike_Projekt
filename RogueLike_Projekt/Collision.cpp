...
/** \brief  Funkcja sprawdzająca kolizję
 *
 * Funckja, dzięki której sprawdzamy kolizję między wszystkimi przeszkodami, potworami i nabojami oraz jeżeli to potrzebne to obsługujemy kolizję przed odbicie od krawędzi sprawdzanych między sobą obiektami
 * @param ob1 Wskaźnik na pierwszy obiekt
 * @param ob2 Wskaźnik na drugi obiekt
 * @return true Jeżeli kolizja została wykryta
 * @return false Jeżeli kolizja nie została wykryta
 */
