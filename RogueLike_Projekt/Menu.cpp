...
/** \brief  Funkcja wyświetlająca menu
 *
 * Funkcja ułatwiająca wyświetlanie wszystkich potrzebnych elementów menu
...
/** \brief  Funkcja aktualizująca menu
 *
 * Funkcja aktualizujaca menu pod wpływem wyboru gracza
 * @param window Wskaźnik na okno, w którym ma wyświetlić przedmiot
 * @param mainMusic Wskaźnik na główną muzykę gry
 * @param bossMusic Wskaźnik na muzykę odtwarzaną podczas walki z Bossem
 */
...
/** \brief  Funkcja zwracająca teksture guzika
 *
