...
class monster : public hero
{
    ...
    public:
        ...
        monster(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float speed, float fire_rate, float shot_speed, float health, 
            ...
            :hero(texture, imageCount, switchTime, speed, fire_rate, shot_speed, health,damage, size, position,flying), shooting(shooting), resurection(resurection), memHealth(health) {}
